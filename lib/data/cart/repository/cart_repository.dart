...
class CartRepository implements ICartRepository {
  ...
  @override
  Future<Either<Failure, CartServerModal>> getCartFromServer(String currency,
    ...
    try {
      ...
      if (resp.statusCode == 200) {
        ...
        return Right(data.toDomain(currency));
  ...
  Future<Either<Failure, CartServerModal>> couponUnApply(
    ...
    return res.fold((l) => Left(l), (r) {
      ...
      final domainData = response.data.toDomain(currency);
      return Right(domainData);
    });
  }
