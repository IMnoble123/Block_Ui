...
FetchOrderProductDetailsResponse _$FetchOrderProductDetailsResponseFromJson(
...
Map<String, dynamic> _$FetchOrderProductDetailsResponseToJson(
        FetchOrderProductDetailsResponse instance) =>
    <String, dynamic>{
