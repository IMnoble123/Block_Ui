                                ...
                                child: DropdownButton<CountryModal>(
                                  ...
                                  onChanged: (newValue) {
                                    BlocProvider.of<CalculateBloc>(context).add(
                                        CalculateEvent.selectedCountryChanged(
                                            newValue));
                                  },
                                    ...
                                    return DropdownMenuItem<CountryModal>(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          //     'assets/flags_svg/${flags[countryCode ?? 'USA']}',
                                          //   ),
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              country.carbonCountryPerCapita,
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .bodyText1
                                                  ?.copyWith(
                      ...
                      Expanded(
                        child: SliderTheme(
                          data: SliderThemeData(
                            ...
                            inactiveTrackColor:
                                AppColors.appGreyColor.withOpacity(.5),
                          ...
                          child: Slider(
                            ...
                            onChanged: (newVal) {
                              ...
                              if (state.noOfPeopleUsingTransport > newVal) {
                                BlocProvider.of<CalculateBloc>(context).add(
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style: Theme.of(context)
                                .textTheme
                                .bodyText1
                                ?.copyWith(letterSpacing: .1, fontSize: 14.sp),
                          ),
                        ),
                      ),
                      Expanded(
                        child: SliderTheme(
                          data: SliderThemeData(
                            ...
                            //     value: state.noOfPeopleUsingTransport.toDouble()),
                            trackHeight: 21.h,
                            thumbShape: CustomSliderThumbCircle(
                                min: 0,
                                max: state.noOfPeople,
                          ...
                          child: Slider(
                            ...
                            label: state.noOfPeopleUsingTransport.toString(),
                            onChanged: (value) {
                              BlocProvider.of<CalculateBloc>(context).add(
                                  CalculateEvent
                                      .noOfPeopleUsingTransportChanged(
                  ...
                  Column(
                    children: [
                      ToggleTab(
                        ...
                        onChanged: (index) {
                          BlocProvider.of<CalculateBloc>(context).add(
                              CalculateEvent.incomeChanged(indexAsKey[index]!));
                        },
                        title: 'Income',
                      ),
                      SizedBox(
