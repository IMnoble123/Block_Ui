...
class CartEvent with _$CartEvent {
  ...
  const factory CartEvent.setCartSyncedToServer(CartSyncedToServerOnAuth cartSyncedToServerOnAuth ) = CartsetCartSyncedToServer;
...
enum SaveActionType { save, remove }
//
//
