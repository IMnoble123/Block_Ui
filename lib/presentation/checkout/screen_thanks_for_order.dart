...
class _ScreenThanksForOrderState extends State<ScreenThanksForOrder> {
  ...
  Widget build(BuildContext context) {
    ...
    BlocProvider.of<UserProfileBloc>(context).add(const UserProfileEvent.fetchOrders());
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                          ...
                          children: [
                            ...
                            Text(
                              getPriceFormattedWithCODE(
                                  createOrderResponse.order?.currency ?? "USD",
                      ...
                      if (createOrderResponse.order?.calculatedCouponDiscount !=
                          null)
  ...
  Table _createDataTable(
    ...
    return Table(
      ...
      children: List.generate(createOrderResponse.order?.products?.length ?? 0,
        ...
        double? unitPrice = product?.price != null
