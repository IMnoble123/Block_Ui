...
class BottomPageViewFirst extends StatelessWidget {
  BottomPageViewFirst({Key? key, required this.pageController})
      : super(key: key);
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      "${getPriceFormattedWithCODE(state.paymentCurrency, state.discount)}",
                                      style: Theme.of(context)
                                          .textTheme
                                          .subtitle1
                                          ?.copyWith(
                                ...
                                child: AppButton(
                                  ...
                                  onTap: () {
                                    BlocProvider.of<CheckoutBloc>(context).add(
                                        CheckoutEvent.removeCoupon(
                                            checkoutType: state.checkoutType));
                                  },
                                  text: SvgPicture.asset(SvgAssets.deleteIcon),
