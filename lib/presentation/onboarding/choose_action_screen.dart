...
class _ScreenChooseActionState extends State<ScreenChooseAction> {
  ...
  void initState() {
    super.initState();
    print("initState  of ScreenChooseAction");
    // onClickNotification.stream.listen((event) {
    //   if (event.didNotificationLaunchApp) {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            //     typeNumber: 8,
                            //     size: 150,
                            //     data: "${AppStrings.webBase}/c/muhammed",
  ...
  // Future<dynamic>? buildShowDialog(BuildContext context, UserProfileState state,
  //     AppControllerState appState) {
  ...
  //             height: 250.h,
  //             child: AlertDialog(
  //               title: const Text('Please confirm your default currency'),
  //               content: Column(
  //                 mainAxisSize: MainAxisSize.min,
  //                 children: [
  //                   Container(
  //                     child: Text(
  //                         'We found your currency in your profile as ${state.userProfileModal?.user.defaultCurrency} and you are currently selected ${appState.currency}'),
  //                   ),
  //                   Container(
  //                     child: Text('Please choose a currency to use'),
  //                   ),
  //                   SizedBox(
  //                     height: 12.h,
  //                   ),
  ...
  //                           'defaultCurrency': appState.currency
  //                         }));
  //                         Navigator.pop(ctx);
  //                       },
  //                       text: Text(appState.currency)),
  //                   SizedBox(
  //                     height: 12.h,
  //                   ),
  //                   AppOutlinedButton(
  ...
  //                                 currency: state
  //                                     .userProfileModal!.user.defaultCurrency));
  //                         Navigator.pop(ctx);
  //                       },
  //                       text: Text(
