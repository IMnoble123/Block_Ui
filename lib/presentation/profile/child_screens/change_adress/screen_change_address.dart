...
class _ScreenChangeAddressState extends State<ScreenChangeAddress> {
  ...
  initFields(UserProfileModal? profileModal) {
    ...
    _contactNumberController.text = billingAddress?.contactNo ?? '';
        ...
        body: SafeArea(
          child: BlocBuilder<UserProfileBloc, UserProfileState>(
            builder: (context, state) {
              ...
              initCountryCode = countryCodesA2ToA3[details.alpha2Code] ?? '';
  ...
  Future<void> submitForm(
    ...
    final res =
        await userProfileRepository.createOrUpdateAddress(billingAddressModal);
    res.fold((l) {
