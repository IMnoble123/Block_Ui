...
//${DateFormat('yyyy-MM-dd').format(DateTime.fromMillisecondsSinceEpoch(orderModal.subscriptionCancelledAt))}
  ...
  _showManageSubs(BuildContext context, BuildContext modalCtx) async {
    try {
      await getIt<DioManager>().post('/v1/get-stripe-id',
          data: {"id": orderModal.paymentLogModal.first.id}).then((value) {
          ...
          GestureDetector(
            onTap: () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => CertificateWebView(url: 'https://www.africau.edu/images/default/sample.pdf',
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  spaceFormatOrderNum(product.certificateNumber),
                  style: textTheme.headline2
                      ?.copyWith(color: AppColors.primaryActiveColor),
                ),
                SizedBox(
